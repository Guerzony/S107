...
class ExportSpeedOvensFileController {
    ...
    async handle(httpRequest) {
        try {
            ...
            if (params.userModel !== 'COPA, ROCKET, COPA SM' && params.userModel !== 'FIT, FIT ST' && params.userModel !== 'FORZA')
                return (0, http_helper_1.badRequest)(new errors_1.InvalidParamError('userModel'));
            ...
            const { filePath, folderPath } = await this.exportSpeedOvensFile.export({ configs, groups, recipies }, params.userModel);
