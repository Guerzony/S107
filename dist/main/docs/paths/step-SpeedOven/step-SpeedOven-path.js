...
exports.stepSpeedOvenByIdPath = exports.stepSpeedOvenByRecipeIdPath = exports.stepSpeedOvenPath = void 0;
exports.stepSpeedOvenPath = {
    post: {
        security: [{
                apiKeyAuth: []
            }],
...
exports.stepSpeedOvenByRecipeIdPath = {
    get: {
        security: [{
                apiKeyAuth: []
            }],
