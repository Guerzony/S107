...
exports.makeSendEmailResetPasswordValidation = void 0;
...
const makeSendEmailResetPasswordValidation = () => {
    const validations = [];
    const fields = ['email'];
...
exports.makeSendEmailResetPasswordValidation = makeSendEmailResetPasswordValidation;
