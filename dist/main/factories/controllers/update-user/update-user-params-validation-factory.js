...
exports.makeUpdateUserParamsValidation = void 0;
...
const makeUpdateUserParamsValidation = () => {
    const validations = [];
    const fields = ['id'];
...
exports.makeUpdateUserParamsValidation = makeUpdateUserParamsValidation;
