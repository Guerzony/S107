...
exports.makeExportTsiFileValidationFactory = void 0;
...
const makeExportTsiFileValidationFactory = () => {
    const validations = [];
    const fields = ['menuId'];
...
exports.makeExportTsiFileValidationFactory = makeExportTsiFileValidationFactory;
