...
exports.makeExportForzaFileValidationFactory = void 0;
...
const makeExportForzaFileValidationFactory = () => {
    const validations = [];
    const fields = ['menuId'];
...
exports.makeExportForzaFileValidationFactory = makeExportForzaFileValidationFactory;
