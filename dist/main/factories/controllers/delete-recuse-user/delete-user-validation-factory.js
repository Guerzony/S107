...
exports.makeDeleteUserValidation = void 0;
...
const makeDeleteUserValidation = () => {
    const validations = [];
    const fields = ['id', 'name', 'companyName', 'email'];
...
exports.makeDeleteUserValidation = makeDeleteUserValidation;
