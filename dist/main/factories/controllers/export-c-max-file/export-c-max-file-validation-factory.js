...
exports.makeExportCMaxFileValidationFactory = void 0;
...
const makeExportCMaxFileValidationFactory = () => {
    const validations = [];
    const fields = ['menuId'];
...
exports.makeExportCMaxFileValidationFactory = makeExportCMaxFileValidationFactory;
