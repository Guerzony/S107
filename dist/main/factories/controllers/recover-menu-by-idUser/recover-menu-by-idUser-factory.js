...
const db_recover_add_user_factory_1 = require("../../usecases/recover-add-user/db-recover-add-user-factory");
...
const makeRecoverMenuByIdUserDataController = (pool) => {
    ...
    const loadUserDataController = new recover_menu_controller_1.RecoverMenusController((0, recover_menu_by_idUser_validation_factory_1.makeRecoverAddMenuValidation)(), (0, db_recover_load_menu_by_idUser_factory_1.makeRecoverLoadMenuByIdUser)(), (0, db_recover_add_menu_factory_1.makeRecoverAddMenu)(pool), (0, db_load_userOld_by_email_factory_1.makeDbLoadUserOld)(pool), (0, db_load_equipOld_by_idUser_factory_1.makeDbLoadUserOld)(), (0, db_recover_add_user_factory_1.makeRecoverAddUser)(pool), new send_email_adapter_1.MailService());
