...
exports.makeUpdateStepCombiOvenTSIParamsValidation = void 0;
...
const makeUpdateStepCombiOvenTSIParamsValidation = () => {
    const validations = [];
    const fields = ['id'];
...
exports.makeUpdateStepCombiOvenTSIParamsValidation = makeUpdateStepCombiOvenTSIParamsValidation;
