...
exports.makeUpdateStepSpeedOvenParamsValidation = void 0;
...
const makeUpdateStepSpeedOvenParamsValidation = () => {
    const validations = [];
    const fields = ['id'];
...
exports.makeUpdateStepSpeedOvenParamsValidation = makeUpdateStepSpeedOvenParamsValidation;
