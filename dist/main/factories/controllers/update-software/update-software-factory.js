...
const makeUpdateSoftwareController = (pool) => {
    ...
    const updateSoftwareController = new update_software_controller_1.UpdateSoftwareController((0, db_update_software_1.makeDbUpdateSoftware)(), (0, update_software_validation_factory_1.makeUpdateSoftwareValidation)(), (0, db_load_equip_by_pin_factory_1.makeLoadUserByPin)(pool));
