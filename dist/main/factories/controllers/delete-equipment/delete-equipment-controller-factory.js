...
const makeDeleteUserController = (pool) => {
    ...
    const deleteUserController = new delete_user_controller_1.DeleteUserController((0, delete_user_validation_factory_1.makeDeleteUserValidation)(), (0, db_delete_user_factory_1.makeDbDeleteUser)(pool));
