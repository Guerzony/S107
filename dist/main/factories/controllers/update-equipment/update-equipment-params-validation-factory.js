...
exports.makeUpdateEquipmentParamsValidation = void 0;
...
const makeUpdateEquipmentParamsValidation = () => {
    const validations = [];
    const fields = ['id'];
...
exports.makeUpdateEquipmentParamsValidation = makeUpdateEquipmentParamsValidation;
