...
exports.makeLoadUserByCompanyValidation = void 0;
...
const makeLoadUserByCompanyValidation = () => {
    const validations = [];
    const fields = ['id'];
...
exports.makeLoadUserByCompanyValidation = makeLoadUserByCompanyValidation;
