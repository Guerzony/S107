...
exports.makeDeleteStepCombiOvenTSIValidation = void 0;
...
const makeDeleteStepCombiOvenTSIValidation = () => {
    const validations = [];
    const fields = ['id'];
...
exports.makeDeleteStepCombiOvenTSIValidation = makeDeleteStepCombiOvenTSIValidation;
