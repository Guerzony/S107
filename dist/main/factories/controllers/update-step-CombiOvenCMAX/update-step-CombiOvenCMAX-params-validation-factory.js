...
exports.makeUpdateStepCombiOvenCMAXParamsValidation = void 0;
...
const makeUpdateStepCombiOvenCMAXParamsValidation = () => {
    const validations = [];
    const fields = ['id'];
...
exports.makeUpdateStepCombiOvenCMAXParamsValidation = makeUpdateStepCombiOvenCMAXParamsValidation;
