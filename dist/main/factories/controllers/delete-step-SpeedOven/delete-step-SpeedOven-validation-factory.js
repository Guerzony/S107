...
exports.makeDeleteStepSpeedOvenValidation = void 0;
...
const makeDeleteStepSpeedOvenValidation = () => {
    const validations = [];
    const fields = ['id'];
...
exports.makeDeleteStepSpeedOvenValidation = makeDeleteStepSpeedOvenValidation;
