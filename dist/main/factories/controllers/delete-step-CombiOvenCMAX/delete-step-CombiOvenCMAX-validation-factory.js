...
exports.makeDeleteStepCombiOvenCMAXValidation = void 0;
...
const makeDeleteStepCombiOvenCMAXValidation = () => {
    const validations = [];
    const fields = ['id'];
...
exports.makeDeleteStepCombiOvenCMAXValidation = makeDeleteStepCombiOvenCMAXValidation;
