...
exports.makeUpdateCookbookParamsValidation = void 0;
...
const makeUpdateCookbookParamsValidation = () => {
    const validations = [];
    const fields = ['id'];
...
exports.makeUpdateCookbookParamsValidation = makeUpdateCookbookParamsValidation;
