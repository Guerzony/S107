...
exports.makeUpdateCookbookBodyValidation = void 0;
...
const makeUpdateCookbookBodyValidation = () => {
    const validations = [];
    const fields = [
        'equipTypeId',
        'recipeName',
...
exports.makeUpdateCookbookBodyValidation = makeUpdateCookbookBodyValidation;
